...
<head>
    ...
    <title>Flowiee | Danh mục kênh bán hàng</title>
                        ...
                        <div class="card">
                                ...
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    ...
                                    <th:block th:each="list, index : ${listDanhMuc}">
                                        <tr>
                                            ...
                                            <td th:text="${list.mauNhan}"
                                                th:attr="style='background-color: ' + ${list.mauNhan} + ';'"></td>
                                            <td>
                                                ...
                                                <div class="modal fade" th:id="'delete-' + ${list.id}">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form th:action="@{/danh-muc/kenh-ban-hang/delete/{id}(id=${list.id})}"
                                                                  th:object="${kenhBanHang}" method="post">
                                                                <div class="modal-header">
                                                                    <strong class="modal-title">Xác nhận xóa kênh bán
                                                                        hàng</strong>
                                            ...
                                            <th:block>
                                                ...
                                                <div class="modal fade" th:id="'update-' + ${list.id}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <form th:action="@{/danh-muc/kenh-ban-hang/update/{id}(id=${list.id})}"
                                                                  th:object="${kenhBanHang}" method="post">
                                                                <div class="modal-header">
                                                                    <strong class="modal-title">Cập nhật kênh bán
                                                                        hàng</strong>
                                                                    <button type="button" class="close"
                                                                            data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input class="form-control my-colorpicker1"
                                                                                       type="text" name="mauNhan"
                                                                                       th:value="${list.mauNhan}"
                                                                                       required/>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label>Ghi chú</label>
                            ...
                            <th:block>
                                ...
                                <div class="modal fade" id="insert">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form th:action="@{/danh-muc/kenh-ban-hang/insert}"
                                                  th:object="${kenhBanHang}" method="post">
                                                <div class="modal-header">
                                                    <strong class="modal-title">Thêm mới kênh bán hàng</strong>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
