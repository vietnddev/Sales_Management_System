...
<head>
    ...
    <title>Flowiee | Danh mục hình thức thanh toán</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row justify-content-between">
                                    <div class="col-4" style="display: flex; align-items: center">
                                        <h3 class="card-title"><strong>DANH MỤC HÌNH THỨC THANH TOÁN</strong></h3>
                                    </div>
                                                        ...
                                                        <div class="modal-content">
                                                            <form th:action="@{/danh-muc/loai-san-pham/delete/{id}(id=${list.id})}"
                                                                ...
                                                                <div class="modal-header">
                                                                    <strong class="modal-title">Xác nhận xóa loại sản
                                                                        phẩm</strong>
                                            ...
                                            <th:block>
                                                ...
                                                <div class="modal fade" th:id="'update-' + ${list.id}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <form th:action="@{/danh-muc/hinh-thuc-thanh-toan/update/{id}(id=${list.id})}"
                                                                  th:object="${hinhThucThanhToan}" method="post">
                                                                <div class="modal-header">
                                                                    <strong class="modal-title">Cập nhật hình thức thanh
                                                                        toán</strong>
                                                                    <button type="button" class="close"
                                                                            data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                            ...
                            <th:block>
                                ...
                                <div class="modal fade" id="insert">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form th:action="@{/danh-muc/hinh-thuc-thanh-toan/insert}"
                                                  th:object="${hinhThucThanhToan}" method="post">
                                                <div class="modal-header">
                                                    <strong class="modal-title">Thêm mới hình thức thanh toán</strong>
