            ...
            <div class="row col-sm-7 mt-3"
              ...
              <div class="row col-sm-12 justify-content-between" style="align-items: center; padding: 0;">
                <div class="col-sm-8 text-left" style="padding: 0;">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group row col-sm-12 p-0">
                        <input type="text" class="form-control col-sm-11" style="color: red; font-weight: bold;"
                          placeholder="Giá bán" name="price" th:value="${listPrices.get(0).getPrice()}" required />
                        <span class="input-group-append">
              ...
              <div class="col-sm-12 text-right">
                <button type="button" class="btn btn-primary mb-1" name="addToFavourite"><i
                  ...
                  thích</button>
                <button type="button" class="btn btn-warning mb-1" data-toggle="modal" data-target="#addToCart"><i
                    class="fas fa-cart-plus fa-lg mr-2"></i>Thêm vào
                  giỏ hàng</button>
                <button type="button" class="btn btn-info mb-1" data-toggle="modal" data-target="#insertSizes">Thêm kích
                  cỡ
                </button>
