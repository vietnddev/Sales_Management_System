              ...
              <div class="card">
                    ...
                    <tbody>
                      <th:block th:each="list : ${listProducts}">
                        <tr>
                          ...
                          <td>
                            <a th:href="@{/sales/products/{id}(id=${list.productID})}">
                              <th:block th:text="${list.name}"></th:block>
                            </a>
                          </td>
                          <td th:text="${list.CategoryID}">
                          </td>
                          <td>
                          ...
                          <td>
                            <button class="btn btn-outline-info btn-sm" style="margin-bottom: 4px;"><a
                                th:href="@{/sales/products/detail/{id}(id=${list.productID})}"><i
                            ...
                            <div class="modal fade" th:id="'delete-' + ${list.productID}">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <form th:action="@{/sales/products/delete/{productID}(productID=${list.productID})}"
                ...
                <th:block>
                  <div class="modal fade" id="insert">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <form th:action="@{/sales/products/insert}" th:object="${products}" method="post">
                          <div class="modal-header">
                              ...
                              <div class="col-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="custom-select" name="categoryID">
                                    <option th:each="lstype, iterStat : ${listTypeProducts}"
                                      th:value="${lstype.categoryID}" th:text="${lstype.name}"
