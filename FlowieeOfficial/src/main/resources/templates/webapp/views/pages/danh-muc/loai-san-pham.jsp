                        ...
                        <div class="card">
                            ...
                            <div class="card-body align-items-center">
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    ...
                                    <tbody>
                                    <th:block th:each="list, index : ${listLoaiSP}">
                                        <tr>
                                            ...
                                            <th:block>
                                                ...
                                                <div class="modal fade" th:id="'update-' + ${list.id}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <form th:action="@{/danh-muc/loai-san-pham/update/{id}(id=${list.id})}"
                                                                  th:object="${loaiSanPham}" method="post">
                                                                <div class="modal-header">
                                                                    <strong class="modal-title">Cập nhật loại sản
                                                                        phẩm</strong>
                                                                    <button type="button" class="close"
                                                                            data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                            ...
                            <th:block>
                                ...
                                <div class="modal fade" id="insert">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form th:action="@{/danh-muc/loai-san-pham/insert}"
                                                  th:object="${loaiSanPham}" method="post">
                                                <div class="modal-header">
