                        ...
                        <div class="card">
                                        ...
                                        <tr>
                                                ...
                                                <div class="modal fade" th:id="'delete-' + ${list.id}">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form th:action="@{/admin/account/delete/{id}(id=${list.id})}"
                                                                  th:object="${account}"
                                                                  method="post">
                                            ...
                                            <th:block><!-- Update -->
                                                <div class="modal fade" th:id="'update-' + ${list.id}">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form th:action="@{/admin/account/update/{id}(id=${list.id})}"
                            ...
                            <th:block>
                                <div class="modal fade" id="insert">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form th:action="@{/admin/account/insert}" th:object="${account}"
                                                  method="post">
                                                <div class="modal-header">
