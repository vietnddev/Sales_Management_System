...
import com.flowiee.app.category.service.LoaiMauSacService;
...
public class LoaiMauSacController {
    ...
    public ModelAndView findAll() {
        ...
        if (kiemTraQuyenModule.kiemTraQuyenXem()) {
            ...
            modelAndView.addObject("url_template", EndPointUtil.DANHMUC_LOAIMAUSAC_TEMPLATE);
            modelAndView.addObject("url_import", EndPointUtil.DANHMUC_LOAIMAUSAC_IMPORT);
            modelAndView.addObject("url_export", EndPointUtil.DANHMUC_LOAIMAUSAC_EXPORT);
    ...
    public String importData(@RequestParam("file") MultipartFile file) {
        ...
        if (kiemTraQuyenModule.kiemTraQuyenExport()) {
            loaiMauSacService.importData(file);
            return "redirect:" + EndPointUtil.DANHMUC_LOAIMAUSAC_VIEW;
        } else {
