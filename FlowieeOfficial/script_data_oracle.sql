...
INSERT INTO PRO_SAN_PHAM(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUES ('Áo sơ mi sọc tay dài', (SELECT ID FROM category WHERE TYPE = 'BRAND' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' AND ROWNUM <= 1), 1);
INSERT INTO PRO_SAN_PHAM(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUES ('Áo thun unisex', (SELECT ID FROM category WHERE TYPE = 'BRAND' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' AND ROWNUM <= 1), 1);
INSERT INTO PRO_SAN_PHAM(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUES ('Quần sọt', (SELECT ID FROM category WHERE TYPE = 'BRAND' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' AND ROWNUM <= 1), 1);
INSERT INTO PRO_SAN_PHAM(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUES ('Quần jean', (SELECT ID FROM category WHERE TYPE = 'BRAND' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' AND ROWNUM <= 1), 1);
INSERT INTO PRO_SAN_PHAM(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUES ('Áo khoác có nón', (SELECT ID FROM category WHERE TYPE = 'BRAND' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' AND ROWNUM <= 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' AND ROWNUM <= 1), 1);
