...
INSERT INTO pro_san_pham(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUE ('Áo sơ mi sọc tay dài', (SELECT ID FROM category WHERE TYPE = 'BRAND' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' LIMIT 1), true);
INSERT INTO pro_san_pham(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUE ('Áo thun unisex', (SELECT ID FROM category WHERE TYPE = 'BRAND' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' LIMIT 1), true);
INSERT INTO pro_san_pham(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUE ('Quần sọt', (SELECT ID FROM category WHERE TYPE = 'BRAND' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' LIMIT 1), true);
INSERT INTO pro_san_pham(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUE ('Quần jean', (SELECT ID FROM category WHERE TYPE = 'BRAND' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' LIMIT 1), true);
INSERT INTO pro_san_pham(TEN_SAN_PHAM, BRAND_ID, PRODUCT_TYPE_ID, UNIT_ID, TRANG_THAI) VALUE ('Áo khoác có nón', (SELECT ID FROM category WHERE TYPE = 'BRAND' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'PRODUCTTYPE' LIMIT 1), (SELECT ID FROM category WHERE TYPE = 'UNIT' LIMIT 1), true);

INSERT INTO pro_customer(TEN_KHACH_HANG, GIOI_TINH) VALUES ('Nguyễn Đức Việt', true);
INSERT INTO pro_customer(TEN_KHACH_HANG, GIOI_TINH) VALUES ('Bùi Văn Tấn Đạt', true);
