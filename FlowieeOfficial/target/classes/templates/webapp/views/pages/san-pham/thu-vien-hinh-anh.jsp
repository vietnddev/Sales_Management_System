                ...
                <div class="card-body" style="min-height: 600px; overflow: overlay;">
                  <div>
                    <div class="btn-group w-100 mb-2">
                      ...
                      <a class="btn btn-info" href="javascript:void(0)" th:data-filter="${listp.id}" th:each="listp : ${listSanPham}" th:text="${listp.tenSanPham}"></a>
                    </div>
                    <div class="mb-2">
                  ...
                  <div>
                    <div class="filter-container p-0 row col-sm-12">
                      <div class="filtr-item col-sm-2" th:data-category="${list.sanPham.id}" th:each="list : ${listImages}" style="min-height: 200px; width: 100%; display: inline;">
                        <a th:href="@{'/' + ${list.directoryPath} + '/' + ${list.tenFileKhiLuu}}" data-toggle="lightbox"
