...
public class MessageUtils {
    ...
    public static final String CODE_MISSING = "Code is missing";
    public static final String USERNAME_MISSING = "Username is missing";
    public static final String FULL_NAME_MISSING = "Fullname is missing";
    public static final String EMAIL_MISSING = "Email is missing";
