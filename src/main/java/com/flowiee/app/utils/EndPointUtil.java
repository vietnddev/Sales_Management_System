...
public class EndPointUtil {
    ...
    public static String PRO_GALLERY = "/san-pham/gallery";
    ...
    public static String CATEGORY_UNIT = "/system/category/unit";
    ...
    public static String CATEGORY_SALESCHANNEL = "/system/category/sales-channel";
    ...
    public static String CATEGORY_COLOR= "/system/category/color";
    ...
    public static String CATEGORY_SIZE = "/system/category/size";
    ...
    public static String CATEGORY_PAYMETHOD = "/system/category/pay-method";
    ...
    public static String CATEGORY_PRODUCTTYPE = "/system/category/product-type";
    ...
    public static String CATEGORY_DOCUMENTTYPE = "/system/category/document-type";
    ...
    public static String CATEGORY_ORDERSTATUS = "/system/category/order-status";

    public static String CATEGORY_BRAND = "/system/category/brand";

    public static String CATEGORY_FABRICTYPE = "/system/category/fabric-type";
