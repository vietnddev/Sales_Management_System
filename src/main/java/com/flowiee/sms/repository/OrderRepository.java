...
//    Page<Object[]> findAll(@Param("orderId") Integer orderId, @Param("customerId") Integer customerId, Pageable pageable);
    ...
    @Query("select distinct o from Order o " +
           ...
           "and (:orderId is null or o.id=:orderId) " +
           "and (:customerId is null or o.customer.id=:customerId)")
    Page<Order> findAll(@Param("orderId") Integer orderId, @Param("customerId") Integer customerId, Pageable pageable);
...
//    Double findRevenueThisMonth();
    ...
    void updatePaymentStatus(@Param("orderId") Integer orderId, @Param("paymentTime") Date paymentTime, @Param("paymentMethod") Integer paymentMethod, @Param("paymentAmount") Float paymentAmount, @Param("paymentNote") String paymentNote);
