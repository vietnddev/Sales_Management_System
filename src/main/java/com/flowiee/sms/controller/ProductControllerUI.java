...
public class ProductControllerUI extends BaseController {
    private final ProductService productService;
    private final FileStorageService fileStorageService;
    private final VoucherService voucherService;

    @Autowired
    public ProductControllerUI(ProductService productService, FileStorageService fileStorageService, VoucherService voucherService) {
