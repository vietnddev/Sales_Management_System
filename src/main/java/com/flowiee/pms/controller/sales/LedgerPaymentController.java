...
@RestController
@RequestMapping("${app.api.prefix}/ledger-payment")
@Tag(name = "LedgerPayment API", description = "Quản lý phiếu chi")
public class LedgerPaymentController extends BaseController {
    @Autowired
    ...
    public AppResponse<List<LedgerPayment>> findLedgerPayments(@RequestParam(value = "pageSize", required = false) Integer pageSize,
