...
public enum ACTION {
    ...
    STG_MAT_R("Xem danh sách nguyên vật liệu", "STORAGE"),
    STG_MAT_C("Thêm mới nguyên vật liệu", "STORAGE"),
    STG_MAT_U("Cập nhật nguyên vật liệu", "STORAGE"),
    STG_MAT_D("Xóa nguyên vật liệu", "STORAGE"),
    STG_TICKET_IM("Nhập hàng", "STORAGE"),
    STG_TICKET_EX("Xuất hàng", "STORAGE"),
