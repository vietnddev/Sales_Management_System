...
public class ApiResponse<T> implements Serializable {
    ...
    public ApiResponse(Boolean success, HttpStatus status, String message, T data, PaginationModel pagination) {
    ...
    public static <T> ApiResponse<T> ok(@NonNull String message, @NonNull T data, HttpStatus httpStatus) {
        return new ApiResponse<>(true, httpStatus, message, data, null);
    }

    public static <T> ApiResponse<T> ok(@NonNull String message, @NonNull T data, HttpStatus httpStatus, PaginationModel pagination) {
        return new ApiResponse<>(true, httpStatus, message, data, pagination);
    }

    public static <T> ApiResponse<T> fail(@NonNull String message, @NonNull HttpStatus httpStatus) {
