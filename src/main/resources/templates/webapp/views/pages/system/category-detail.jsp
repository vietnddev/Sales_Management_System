                        ...
                        <div class="card">
                            ...
                            <div class="card-body align-items-center">
                                <table id="example1" class="table table-bordered table-striped align-items-center">
                                    ...
                                    <tbody>
                                    <th:block th:each="entity, index : ${listSubCategory}">
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td th:text="${entity.isDefault}"></td>
                                            ...
                                            <th:block>
                                                ...
                                                <div class="modal fade" th:id="'update-' + ${entity.id}">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <form th:action="@{/system/category/update/{id}(id=${entity.id})}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="modal-footer justify-content-end" style="margin-bottom: -15px;">
                                                                        <input type="hidden" name="type" th:value="${ctgRootType}">
                                                                        <input type="hidden" name="isDefault" th:value="${entity.isDefault}">
                            ...
                            <div class="modal fade" id="insert">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <form th:action="@{'/system/category/' + ${ctgRootType} + '/insert'}"
                                              th:object="${category}" method="post">
                                            <div class="modal-header">
